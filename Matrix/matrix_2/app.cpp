...
void App::input() {
	...
	parametr_for_line.setFrequency(getRightNumber("Введите частоту (1-30): ", "line"));
	parametr_for_line.setSpeed(getRightNumber("Введите скорость (1-30): ", "line"));
	parametr_for_line.setLenght(getRightNumber("Введите длину (1-30): ", "line"));
	parametr_for_line.setEpilepsyFlag(getRightText("Эпилепсия (yes/no): "));

	system("cls");

	parametr_for_line.setChance(getRightNumber("Введите шанс взрыва (1-1000): ", "chance"));
	input_radius();
